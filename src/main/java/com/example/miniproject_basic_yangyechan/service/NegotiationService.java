...
public class NegotiationService {
    ...
    public ProposalDto createProposal(ProposalDto dto, Long item_id) {
    ...
    public ProposalDto updateProposal(Long item_id, Long proposalid, ProposalDto dto) {
    ...
    public void deleteProposal(Long item_id, Long proposalid, ProposalDto Dto) {
    ...
    public ProposalDto updateProposalStatus(Long item_id, Long proposalid, ProposalDto dto) {
    ...
    public ProposalDto updateProposalComplete(Long item_id, Long proposalid, ProposalDto dto) {
        Optional<NegotiationEntity> optionalEntity2
                = repository.findById(proposalid);
        if (optionalEntity2.isPresent()) {
            NegotiationEntity item = optionalEntity2.get();
